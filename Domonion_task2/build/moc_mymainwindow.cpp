...
#include "../Domonion_task2/mymainwindow.h"
...
QT_MOC_LITERAL(1, 13, 19), // "createAddressWindow"
QT_MOC_LITERAL(2, 33, 0) // ""

    },
    "MyMainWindow\0createAddressWindow\0"
};
...
void MyMainWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->createAddressWindow((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
    }
}
